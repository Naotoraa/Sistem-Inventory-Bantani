...
<body class="flex flex-col min-h-screen">
    ...
    <div class="content">
        <section id="dashboard">
            <h2 class="table-title">Barang Eror</h2>
            <h4 class="sub-title">Menu Untuk Mengatur Barang Eror</h4>
            <form method="get" action="barang_eror.php">
        ...
        <section class="form-container" id="form_edit_insert">
            <h2 class="table-title" id="table-title-form">Form <?= isset($data_update) ? 'Update' : 'Input'; ?> Barang
                Eror</h2>
            <form action="barang_eror.php" method="POST">
                ...
                <div class="form-actions">
                    <button type="button" class="cancel-btn" data-redirect="barang_eror.php">
