...
<body class="flex flex-col min-h-screen">
    ...
    <script src="../../assets/js/button_cancel.js"></script>
    <script src="../../assets/js/button_delete.js"></script>
    <script src="../../assets/js/button_save.js"></script>
    <script src="../../assets/js/isi_otomatis.js"></script>
